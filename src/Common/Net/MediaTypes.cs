...
namespace KodeAid.Net
{
    public static class MediaTypes
    {
        ...
        private static readonly IDictionary<string, string> _extensionToMediaTypeMappings = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase)
        {
            { "323", "text/h323" },

...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddRegisteredServices(this IServiceCollection services, Assembly startingPoint = null, AssemblySearchOptions assemblySearchOptions = AssemblySearchOptions.Default, params string[] assemblyNamePrefixes)
        {
            var registrationTypes = ReflectionHelper.FindAllTypes<IServiceRegistration>(startingPoint: startingPoint, assemblySearchOptions: assemblySearchOptions, assemblyNamePrefixes: assemblyNamePrefixes);

...
{
    public abstract class JsonSerializerBase : IJsonSerializer, ISerializer
    {
        public string Serialize(object graph)
        {
            ...
            {
                GetInnerSerializer().Serialize(jw, graph);
                jw.Flush();
                sw.Flush();
            }
            return sb.ToString();
        ...
        public object Deserialize(Type type, string json)
        {
            ...
            return GetInnerSerializer().Deserialize(jr, type);
        }
        ...
        protected abstract Newtonsoft.Json.JsonSerializer GetInnerSerializer();
    }
}
